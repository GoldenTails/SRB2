...
#define META_TRANSCOLORMAPLIST "TRANSCOLORMAP_T[]"
#define META_TRANSCOLORMAP "TRANSCOLORMAP_T*"
/*#define META_PALETTEMAP "TRANSCOLORMAP_T*PALETTEMAP"
#define META_USESKINCOLOR "TRANSCOLORMAP_T*USESKINCOLOR"*/
