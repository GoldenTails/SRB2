...
// -----------------------
/**	\brief SWR_DrawTransColumn uses this
*/
...
void SWR_DrawViewBorder(void)
{
	...
	SWR_VideoErase(0, top*vid.width+side);

	// copy one line of right side and bottom
	ofs = (viewheight+top)*vid.width - side;
	SWR_VideoErase(ofs, top*vid.width + side);
