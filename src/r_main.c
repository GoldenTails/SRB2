...
#include "g_input.h"
#include "r_local.h"
#include "software/sw_splats.h" // faB(21jan): testing
#include "r_sky.h"
#include "hu_stuff.h"
#include "st_stuff.h"
#include "p_local.h"
...
{
	return SWR_CheckViewMorph();
}

void R_ApplyViewMorph(void)
{
	return SWR_ApplyViewMorph();
}
...
void R_RenderPlayerView(player_t *player)
{
	...
	if (rendermode == render_opengl)
	{
		...
		HWR_RenderPlayerView(viewnumber, player);
	}
	else
#endif
	if (rendermode == render_soft)
		SWR_RenderPlayerView(player);
}
