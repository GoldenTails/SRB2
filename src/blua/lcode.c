...
void luaK_posfix (FuncState *fs, BinOpr op, expdesc *e1, expdesc *e2) {
  switch (op) {
    ...
    case OPR_BAND_EQ: codecompound(fs, OP_BAND_EQ, e1, e2); break;
    case OPR_BOR_EQ: codecompound(fs, OP_BOR_EQ, e1, e2); break;
    case OPR_BXOR_EQ: codecompound(fs, OP_BXOR_EQ, e1, e2); break;
    case OPR_BSHL_EQ: codecompound(fs, OP_BSHL_EQ, e1, e2); break;
    case OPR_BSHR_EQ: codecompound(fs, OP_BSHR_EQ, e1, e2); break;
