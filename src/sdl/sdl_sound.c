...
static void Snd_LockAudio(void) //Alam: Lock audio data and uninstall audio callback
{
	...
	else if (((digital_disabled && midi_disabled) || music_disabled)
#ifdef HW3SOUND
...
void I_ShutdownSound(void)
{
	...
	if ((digital_disabled && midi_disabled) || music_disabled)
		SDL_CloseAudio();
...
#endif
#ifndef HAVE_MIXER
	music_disabled = midi_disabled = digital_disabled = true;
#endif
